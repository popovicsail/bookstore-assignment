...
namespace BookstoreApplication.Migrations
{
    ...
    [Migration("20250914232200_AddAuthorAward")]
    partial class AddAuthorAward
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BookstoreApplication.Models.AuthorAward", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_author_award");

                    b.HasIndex("AuthorId")
                        .HasDatabaseName("ix_author_award_author_id");

                    b.HasIndex("AwardId")
                        .HasDatabaseName("ix_author_award_award_id");

                    b.ToTable("author_award", (string)null);
                });
            ...
            modelBuilder.Entity("BookstoreApplication.Models.AuthorAward", b =>
                {
                    b.HasOne("BookstoreApplication.Models.Author", "Author")
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_author_award_authors_author_id");
                    ...
                    b.HasOne("BookstoreApplication.Models.Award", "Award")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_author_award_award_award_id");
